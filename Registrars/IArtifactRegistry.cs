...
namespace HubTo.Abstraction.Registrars
{
    public interface IArtifactRegistry
    {
        ...
        Task<ArtifactInfo> EnsureArtifactAsync(Guid namespaceId, string artifactName, string registrarType, ArtifactInfo? initialMetadata = null, CancellationToken cancellationToken = default);
        ...
        Task UpdateArtifactMetadataAsync(Guid artifactId, ArtifactInfo metadata, CancellationToken cancellationToken = default);
        ...
        Task DeleteVersionAsync(Guid artifactId, string version, CancellationToken cancellationToken = default);
    }
}